...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      { title: "About — Edu Document Solutions" },
      { name: "description", content: "Learn about Edu Document Solutions — our mission, values and team supporting students with educational documentation." },
      { property: "og:title", content: "About — Edu Document Solutions" },
...
const values = [
  { icon: ShieldCheck, title: "Integrity", desc: "We operate with honesty and provide only legitimate guidance." },
  { icon: Heart, title: "Empathy", desc: "Every case is handled with patience and personal attention." },
  { icon: Award, title: "Excellence", desc: "We hold ourselves to the highest professional standards." },
];
    ...
    <>
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-6xl px-6 py-16 sm:py-24 text-center">
          <p className="text-xs font-semibold uppercase tracking-[0.2em] text-[color:var(--gold-deep)]">About Us</p>
          <h1 className="mt-3 text-4xl font-semibold sm:text-5xl">
            A team built on <span className="text-gradient">trust & expertise</span>
          </h1>
          <p className="mx-auto mt-5 max-w-2xl text-muted-foreground">
            Edu Document Solutions has spent years helping students and professionals navigate educational documentation with clarity and care.
          </p>
        </div>
      </section>
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <div className="rounded-3xl border border-border bg-card p-8 shadow-soft">
            ...
            <p className="mt-3 leading-relaxed text-muted-foreground">
              To make educational documentation simple, transparent, and accessible — empowering every student with the guidance they deserve.
            </p>
          </div>
          <div className="rounded-3xl border border-border bg-card p-8 shadow-soft">
            ...
            <p className="mt-3 leading-relaxed text-muted-foreground">
              To become the most trusted partner for educational documentation and verification guidance across the region.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-6xl px-6 py-12">
        <div className="text-center">
          <p className="text-xs font-semibold uppercase tracking-[0.2em] text-[color:var(--gold-deep)]">Our Values</p>
        ...
        <div className="relative overflow-hidden rounded-3xl bg-[image:var(--gradient-hero)] p-10 text-primary-foreground shadow-elegant sm:p-14">
          ...
          <div className="relative grid gap-8 sm:grid-cols-3">
            {[
              ...
              <div key={e.l}>
                <div className="font-display text-3xl font-semibold text-[color:var(--gold)]">{e.v}</div>
      ...
      <section className="mx-auto max-w-6xl px-6 py-16">
        <div className="text-center">
          <p className="text-xs font-semibold uppercase tracking-[0.2em] text-[color:var(--gold-deep)]">Our Team</p>
          <h2 className="mt-3 text-3xl font-semibold sm:text-4xl">Meet the people behind the service</h2>
        ...
        <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {team.map((m) => (
            <div key={m.name} className="rounded-2xl border border-border bg-card p-6 text-center shadow-soft transition hover:-translate-y-1 hover:shadow-elegant">
