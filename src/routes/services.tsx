...
const services = [
  ...
  {
    icon: Users,
    title: "Student Consultation Services",
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-6xl px-6 py-16 sm:py-24 text-center">
          ...
          <p className="mx-auto mt-5 max-w-2xl text-muted-foreground">
            Every service is built around clarity, confidentiality, and genuine guidance — never
            shortcuts.
          </p>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-6xl px-6 pb-20">
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {services.map((s) => (
            <article
              key={s.title}
              className="group relative flex flex-col rounded-2xl border border-border bg-card p-7 shadow-soft transition hover:-translate-y-1 hover:shadow-elegant"
            >
